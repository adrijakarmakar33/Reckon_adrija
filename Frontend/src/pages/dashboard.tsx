    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white overflow-x-hidden">
      ...
      <div className="relative z-10 pt-24 px-6 pb-12">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          >
            <h1 className="text-5xl font-bold mb-4 bg-gradient-to-r from-cyan-500 to-cyan-600
              ...
              <motion.button
                ...
                className={`relative px-8 py-4 rounded-lg font-bold text-lg transition-all duration-300 ${
                  isTraining
                    ...
                    : 'bg-gradient-to-r from-cyan-500 to-white-600 hover:from-cyan-400 hover:to-white-100 shadow-lg shadow-cyan-500/50'
                }`}
              >
                {isTraining ? (
