...
export function BlockchainActivity({ transactions }: BlockchainActivityProps) {
  return (
    <motion.div
      ...
      className="backdrop-blur-lg bg-gradient-to-br from-cyan-500/10 to-white-200 border border-cyan-500/30 rounded-xl p-6"
    >
          ...
          >
            <div className="flex items-start justify-between">
              <div className="flex items-start space-x-3 flex-1">
                <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-cyan-500 to-white-200 flex items-center justify-center flex-shrink-0">
