      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {hospitals.map((hospital, index) => (
          <motion.div
            ...
            className="backdrop-blur-lg bg-gradient-to-br from-cyan-500/10 to-white-500/10 border border-cyan-500/30 rounded-xl p-6 hover:border-cyan-500/50 transition-all duration-300"
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-cyan-500 to-white-200 flex items-center justify-center">
            ...
            <div className="space-y-3">
              ...
              <div className="w-full bg-gray-700/50 rounded-full h-2 overflow-hidden">
                <motion.div
                  ...
                  className="h-full bg-gradient-to-r from-cyan-500 to-white-200"
                />
              </div>
