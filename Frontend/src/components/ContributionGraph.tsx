...
export function ContributionGraph({ hospitals }: ContributionGraphProps) {
  ...
  return (
    <motion.div
      ...
      className="backdrop-blur-lg bg-gradient-to-br from-cyan-500/10 to-white-200/10 border border-cyan-500/30 rounded-xl p-6"
    >
        ...
        <BarChart data={data}>
          ...
          <defs>
            <linearGradient id="colorGradient" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#0892ab" stopOpacity={1} />
              <stop offset="100%" stopColor="#0892ab" stopOpacity={1} />
            </linearGradient>
          </defs>
        </BarChart>
      </ResponsiveContainer>
